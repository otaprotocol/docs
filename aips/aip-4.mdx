...
| `ref_hash`       | hash     | Hash of approval record or IPFS CID                                      |
...
- `ref_hash` ensures full auditability
...
6. **Auditability**: ref_hash stores hash of approval record
...
- Protocol remains chain-agnostic; PrefixAccount \+ ref_hash are canonical trust anchors
